      ...
      <div className="container mx-auto px-3 md:px-0 h-full relative">
        ...
        >
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="relative w-full md:w-fit py-4 px-6 md:py-6 md:px-10 bg-linear-to-r from-(--main-color)/20 to-(--alt-color)/20 backdrop-blur-sm rounded-tl-[50px] rounded-br-[50px] rounded-tr-[15px] rounded-bl-[15px] shadow-md shadow-(--main-color)/20 transition-transform duration-500 hover:-translate-y-1">
              <h1 className="text-slate-800 text-[24px] md:text-[52px] leading-[1.1] font-extrabold flex items-center gap-x-5 gap-y-1">
                ...
                <div className="flex gap-x-2 md:gap-x-4 text-[17px] md:text-5xl">
            ...
            <div className="flex items-center gap-5 my-5">
              <Link
                href={`/${locale}/contact`}
                className="text-sm md:text-[16px] inline-flex items-center justify-center w-35 md:w-45 py-2 md:py-3 border border-slate-800 duration-300 rounded-lg hover:bg-slate-800 hover:text-[#F9D6B4]"
              >
              ...
              <Link
                ...
                className="text-sm md:text-[16px] inline-flex items-center justify-center w-35 md:w-45 py-2 md:py-3 bg-(--main-color) text-white duration-300 border border-transparent rounded-lg hover:bg-transparent hover:text-slate-800 hover:border-slate-800"
              >
