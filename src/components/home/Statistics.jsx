...
// ... (formatNumber & Counter functions stay the same)
    ...
    >
      <div className="container mx-auto px-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        {stats.map((stat, index) => (
          <div
            key={stat.id}
            // التعديل هنا: إضافة zoom-in مع تأخير متزايد (index * 150)
            data-aos="zoom-in"
          ...
          >
            {/* الأيقونة - ستتحرك مع الكرت وتلف عند الـ Hover بفضل كلاساتك */}
